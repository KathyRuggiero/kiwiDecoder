...
test_codes <- c(
  "C.91606",       # cane — from IMG_2774 (fixed by Stage 5 upscale)
  "C.91632",       # cane — from IMG_2570 (fixed by Stage 2 halves)
  "C.91640",       # cane — from IMG_2573 (always worked)
  "M2126",         # from IMG_0127 (unknown type — general lookup)
  "SC-002-2QQ",    # scion — from IMG_0127
  "T19.58-16-30a", # from IMG_1024 (unknown type — general lookup)
  "RS022354",      # from IMG_6688
  "MC079",         # from IMG_6688
  "SC-002-JWM",    # scion — from IMG_6688
